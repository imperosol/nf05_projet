...
/********************************************//**
 * \file gui_result_presentation.c
 * \brief File that contains functions to display some features with the SDL library.
 * Those functions are to be used in the specific context of the creation of the window to display the results of the hospital simulation.
 *
 * \author Thomas Girod
 * \version 1.0
 * \date 28.11.2020
