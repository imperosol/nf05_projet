...
/********************************************//**
 * \fn void display_patient_individual_top_panel(SDL_Renderer* renderer, patient patientToPrint, const int win_width, const int win_height, SDL_Color text_color, TTF_Font* panel_font)
...
/********************************************//**
 * \fn void display_patient_individual_informations(SDL_Renderer* renderer, patient patientToPrint, const int win_width, const int win_height, SDL_Color text_color, TTF_Font* p_font)
